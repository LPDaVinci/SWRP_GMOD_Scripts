...
if SERVER then
	...
	function ENT:SpawnFunction( ply, tr )
		...
		local ent = ents.Create("sent_binds")
...
local tex = surface.GetTextureID"ucg/binds" -- This is the path/name of your material. You need to do this because of the way it works. You can't just plug the name into SetTexture. You can shove a material made with Material() into surface.SetMaterial though.
function ENT:Draw()
