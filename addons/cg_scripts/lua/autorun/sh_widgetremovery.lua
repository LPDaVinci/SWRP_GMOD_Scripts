...
hook.Add("Initialize","NoWidgets",function()
   ...
   --FUCKING LORD TYLER SHIT
    hook.Remove("Think", "robotBoy Loves Me <3")
    hook.Remove("Think", "sfdgsadf")
	hook.Remove("Think", "freeLoadingNerds")
	hook.Remove("PlayerSpawn", "z")
	hook.Remove("HUDPaint", "drawOurName")
	timer.Destroy("Repeat timer msg")
   --
    hook.Remove("PlayerTick","TickWidgets")
