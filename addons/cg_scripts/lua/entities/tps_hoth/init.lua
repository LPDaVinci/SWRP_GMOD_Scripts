...
function ENT:Initialize()
	...
	self.Active = false
	self:SetModel("models/starwars/syphadias/props/sw_tor/bioware_ea/planets/hoth/hoth.mdl")
...
function ENT:SpawnFunction( ply, tr )
    ...
    local ent = ents.Create("tps_hoth")
...
if ( timer.Exists( "Teleport".. ply:SteamID() ) ) then return false end
	...
	ply:SetPos(( Vector( -3937.541748, -2315.537598, 2157.485107 ) ))
	ply:SetAngles(( Angle (1.980180, 93.242371, 0.000000) ))
	...
	ply:PrintMessage( HUD_PRINTTALK, "Teleport nach Hoth war erfolgreich!" ) 
