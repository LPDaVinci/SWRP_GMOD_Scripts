...
function ENT:Initialize()
	...
	self.Active = false
	self:SetModel("models/starwars/syphadias/props/sw_tor/bioware_ea/planets/nar_shadda/nar_shadda.mdl")
...
function ENT:SpawnFunction( ply, tr )
    ...
    local ent = ents.Create("tps_meteor")
...
if ( timer.Exists( "Teleport".. ply:SteamID() ) ) then return false end
	...
	ply:SetPos(( Vector( 6515.425781, -10444.791016, 9346.759766 ) ))
	ply:SetAngles(( Angle (8.448166, 82.520119, 0.000000) ))
	...
	ply:PrintMessage( HUD_PRINTTALK, "Teleport auf die Meteor Station war erfolgreich!" ) 
