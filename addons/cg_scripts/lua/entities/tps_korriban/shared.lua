ENT.Base 			= "base_ai"
ENT.Type 			= "ai"
ENT.PrintName		= "Korriban"
ENT.Author			= "LPDaVinci"
ENT.Information		= "Teleports you to Planet Korriban"
...
for k, v in pairs(ents.FindByClass("tps_korriban" )) do 

	if LocalPlayer():GetPos():Distance( v:GetPos() ) > 300 then continue end
	
	
	local name = string.Explode( " ", self.PrintName )[1]
