...
function ENT:Initialize()
	...
	self.Active = false
	self:SetModel("models/starwars/syphadias/props/sw_tor/bioware_ea/planets/korriban/korriban.mdl")
...
function ENT:SpawnFunction( ply, tr )
    ...
    local ent = ents.Create("tps_korriban")
...
if ( timer.Exists( "Teleport".. ply:SteamID() ) ) then return false end
	...
	ply:SetPos(( Vector( 5115.960938, 11334.889648, -9363.249023 ) ))
	ply:SetAngles(( Angle (4.157917, 89.333481, 0.000000) ))
	...
	ply:PrintMessage( HUD_PRINTTALK, "Teleport nach Korriban war erfolgreich!" ) 
