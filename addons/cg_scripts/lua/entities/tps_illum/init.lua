...
function ENT:Initialize()
	...
	self.Active = false
	self:SetModel("models/starwars/syphadias/props/sw_tor/bioware_ea/planets/ilum/ilum.mdl")
...
function ENT:SpawnFunction( ply, tr )
    ...
    local ent = ents.Create("tps_illum")
...
if ( timer.Exists( "Teleport".. ply:SteamID() ) ) then return false end
	...
	ply:SetPos(( Vector( 8323.188477, 6639.227051, 6170.951660 ) ))
	ply:SetAngles(( Angle (8.646147, 63.968422, 0.000000) ))
	...
	ply:PrintMessage( HUD_PRINTTALK, "Teleport nach Illum war erfolgreich!" ) 
