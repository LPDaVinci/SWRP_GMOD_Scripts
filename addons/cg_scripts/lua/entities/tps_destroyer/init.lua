...
function ENT:Initialize()
	...
	self.Active = false
	self:SetModel("models/starwars/syphadias/props/sw_tor/bioware_ea/planets/voss/voss.mdl")
...
function ENT:SpawnFunction( ply, tr )
    ...
    local ent = ents.Create("tps_destroyer")
...
if ( timer.Exists( "Teleport".. ply:SteamID() ) ) then return false end
	...
	ply:SetPos(( Vector( 13534.846680, -188.127823, -140.968750 ) ))
	ply:SetAngles(( Angle (3.762187, 0.614329, 0.000000) ))
	...
	ply:PrintMessage( HUD_PRINTTALK, "Teleport zum Star Destroyer war erfolgreich!" ) 
