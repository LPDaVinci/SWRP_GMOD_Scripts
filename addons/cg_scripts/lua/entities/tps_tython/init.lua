...
function ENT:Initialize()
	...
	self.Active = false
	self:SetModel("models/starwars/syphadias/props/sw_tor/bioware_ea/planets/tython/tython.mdl")
...
function ENT:SpawnFunction( ply, tr )
    ...
    local ent = ents.Create("tps_tython")
...
if ( timer.Exists( "Teleport".. ply:SteamID() ) ) then return false end
	...
	ply:SetPos(( Vector( -12969.708008, -12241.081055, 10560.031250 ) ))
	ply:SetAngles(( Angle (5.214062, 49.998089, 0.000000) ))
	...
	ply:PrintMessage( HUD_PRINTTALK, "Teleport nach Tython war erfolgreich!" ) 
